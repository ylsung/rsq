...
# mapfile new_jobs < <(add_additional_jobs "Qwen/Qwen2.5-32B-Instruct" "qwen-2.5-32B-instruct" ${save_name})
...
# --prefix ${q_type}_ \
# --rotated_quantized_checkpoint /nas-hdd/ylsung/checkpoints/qwen-2.5-7B-instruct_${q_type}.pth"
...
# python Baselines/qwen2.5_instruct-test.py \
# --metric exam_eval \
...
# max_length=8k
# folder=Predictions/exam_eval/qwen-2.5-7B-instruct-${max_length}_${q_type}
