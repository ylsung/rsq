...
# 3 to 12
# 3 6 9 12
nsamples_list=(128 256 512 1024)
train_seqlen_list=(8192 4096 2048 1024)
val_size_list=(16 32 64 128)

declare -a jobs

lr=1e-5
for attn_loss_ratio in 10
do
    for i in 1
    do
        ...
        do
            for seed in 0 1 2
            do
                q_type_postfix=next_attn_ratio${attn_loss_ratio}_gd_scale_lr${lr}_prob
                ...
                --optimizer_yaml fake_quant/configs/optimizer/attn1e-2_gd_scale_lr1e-5_bs1.yaml \
                --val_size ${val_size} \
                --seed ${seed} \
                --nsamples ${nsamples} \
