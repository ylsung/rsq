...
do
    ...
    for w_bits in 3 4
    do
        for attn_weighting in org_attn_none3 org_attn_linear3 org_attn_sqrt3
        do
            for seed in ${seeds[@]}
            do
                q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_${attn_weighting}_${q_type_postfix}@${seed}
                ...
                --weighting_apply_module 'self_attn.q_proj.module|self_attn.k_proj.module' \
                --nsamples ${nsamples} \
