    ...
    do
        ...
        do
            ...
            do
                for seed in 0 1 2
                do
                    q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_${attn_weighting}_none${num_bins}_min0@${seed}
...
do
    ...
    do
        ...
        do
            for seed in 0 1 2
            do
                q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_${attn_weighting}${num_bins}_min0@${seed}
                save_name=llama3-8b-instruct_${q_type}
                # no rotate
