...
do
    ...
    do
        for seed in 0 1 2
        do
            q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_preact@${seed}
...
do
    ...
    do
        for seed in 0 1 2
        do
            q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_preact_adaptive_4e-3_4e-1@${seed}
            save_name=llama3-8b-instruct_${q_type}
            # no rotate
