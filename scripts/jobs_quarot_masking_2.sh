...
for w_bits in 3
do
    for half_none_zero_num in 128
    do
        for seed in ${seeds[@]}
        do
            q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_firstlastlinear${half_none_zero_num}_expand8@${seed}
            ...
            --val_size ${val_size} \
            --rotate \
            --module_input_weighting_yaml fake_quant/configs/input_weighting/firstlastlinear.yaml \
            --half_none_zero_num ${half_none_zero_num} \
