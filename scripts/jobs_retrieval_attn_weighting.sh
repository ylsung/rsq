...
do
    ...
    for w_bits in 3 4
    do
        for attn_weighting in org_attn_sqrt_none3 org_attn_square_none3 # org_attn_none3
        do
            for seed in 0 1 2
            do
                q_type=quarot_retrieval_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_${attn_weighting}@${seed}
