...
do
    ...
    do
        for seed in 0 1 2
        do
            q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_adaptive_1e-4_3e-2@${seed}
            ...
            --rotate \
            --adaptive_gptq \
            --values_to_try '[0.0001, 0.0003, 0.001, 0.003, 0.01, 0.03]' \
            --seed ${seed} \
            --val_size ${val_size} \
            --nsamples ${nsamples} \
...
#         for seed in 0 1 2
#         do
#             q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_adaptive@${seed}
