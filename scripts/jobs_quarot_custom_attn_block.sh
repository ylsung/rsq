...
do
    ...
    do
        ...
        do
            for seed in 0 1 2
            do
                q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_${custom_attn_type}${attn_length}_onlyforcustout@${seed}
                ...
                --custom_attn_only_for_cache_output \
