...
do
    ...
    do
        for seed in 0 1 2
        do
            q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_rankafter_995_90_top@${seed}
            ...
            --rotate \
            --values_to_try '[0.995, 0.99, 0.95, 0.9]' \
            --low_rank_after \
            --rank_take_top \
            --adaptive_gptq \
            --seed ${seed} \
...
#         for seed in 0 1 2
#         do
#             q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_rank${rank}_down@${seed}
