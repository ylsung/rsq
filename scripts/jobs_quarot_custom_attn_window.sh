...
i=3
for custom_attn_type in window
do
    ...
    do
        ...
        do
            for seed in 0 1 2
            do
                q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_${custom_attn_type}${attn_length}_stdout@${seed}
...
do
    ...
    do
        ...
        do
            for seed in 0 1 2
            do
                q_type=quarot_${w_bits}bit_w_n${nsamples}_l${train_seqlen}_${custom_attn_type}${attn_length}_custout@${seed}
                save_name=llama3-8b-instruct_${q_type}
                # no rotate
