...
supported_datasets = ['wikitext2', 'ptb', 'c4', 'retrieval', 'pajama']
...
def parser_gen():
    ...
    parser.add_argument('--train_seqlen', type=int, default=2048,
                        help='Sequence length for calibration datset.')
    parser.add_argument('--val_seqlen', type=int, default=2048,
                        help='Sequence length for validation datset.')
    ...
    parser.add_argument('--num_fewshot', type=int, default=None, help='Number of few-shot examples to evaluate on.')
    ...
    if args.layers_dont_quantize is None:
        args.layers_dont_quantize = []
    else:
        args.layers_dont_quantize = [int(x) for x in args.layers_dont_quantize]
    ...
    if args.lm_eval:
        ...
        # initialize dataset
        task_dict = get_task_dict(args.tasks, task_manager)
